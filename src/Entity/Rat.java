...
import static Util.Constants.EnemyConstants.RAT_SIZE;
...
public class Rat extends Enemy{
	...
	public Rat(float x, float y) {
		super(x, y, (int)(RAT_SIZE * Game.SCALE), (int)(RAT_SIZE * Game.SCALE), RAT);
		initCollision(x, y, 46 * Game.SCALE, 42 * Game.SCALE);
		initAttackBox();
		setSpeed(1f);
	...
	private void initAttackBox() {
		attackBox = new Rectangle2D.Float(x, y, (int) (73 * Game.SCALE), (int)(42 * Game.SCALE));
